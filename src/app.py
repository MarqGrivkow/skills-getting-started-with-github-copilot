...
activities = {
    ...
    "Swimming Club": {
        ...
        "max_participants": 16,
        "participants": ["nathan@mergington.edu", "lily@mergington.edu"]
    },
    "Art Studio": {
    ...
    "Drama Club": {
        "description": "Acting, improvisation, and preparing performances for the school community",
        "schedule": "Tuesdays and Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["sarah@mergington.edu", "noah@mergington.edu"]
    },
    "Science Olympiad": {
        "description": "Compete in science and engineering challenges to solve real problems",
